...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
        	<form method="post" action="admin/slider/edit?id={{$id}}&type={{ @$_GET['type'] }}" enctype="multipart/form-data">
			    ...
			    <div class="box-footer">
			    	<div class="row">
						<div class="col-md-6">
					    	...
					    	<button type="button" class="btn btn-danger" onclick="javascript:window.location='admin/slider?type={{ @$_GET['type'] }}'">Thoát</button>
				    	</div>
			    	</div>
			  	</div>
		    </form>
