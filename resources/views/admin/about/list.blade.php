...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#xoahet").click(function(){
      ...
      if (hoi==true) document.location = homeUrl()+"/admin/about/"+listid+"/deleteList?type={{@$_GET[type]}}";
    });
  });
</script>
    ...
    <div class="col-xs-12">
      <div class="box">
              ...
              <tr>
                ...
                <td class="text-center with_dieuhuong">
                  <div class="form-group"> 
                    @if($item->status>0)
                      <a href="admin/about/edit?id={{$item->id}}&hienthi={{ time() }}&type={{ @$_GET['type'] }}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Hiển thị</a>
                    @else
                      <a href="admin/about/edit?id={{$item->id}}&hienthi={{ time() }}&type={{ @$_GET['type'] }}" class="btn btn-danger btn-xs"><i class="fa fa-eye"></i> Hiển thị</a>
                    @endif
                  </div>
                ...
                <td class="text-center with_dieuhuong">
                  <i class="fa fa-pencil fa-fw"></i><a href="admin/about/edit?id={{$item->id}}&type={{ @$_GET['type'] }}">Edit</a>
                </td>
        ...
        <div class="box-footer col-md-12">
          <div class="row">
            <div class="col-md-6">
              <input type="button" onclick="javascript:window.location='admin/about/add?type={{ @$_GET[type] }}'" value="Thêm" class="btn btn-primary" />
