...
class NewsLetterController extends Controller
{
    ...
    public function postAdd(Request $request)
    {
        ...
        $news->save();
        return redirect('admin/newsletter?type='.$com)->with('status','Thêm mới thành công !');
    }
    /**
    ...
    public function getEdit(Request $request)
    {
        ...
        if(!empty($data)){
            if(Request::get('hienthi')>0){
                ...
                $data->update();
                return redirect('admin/newsletter?type='.$com)->with('status','Cập nhật thành công !');
            }
    ...
    public function postNewsLetter(Request $request)
    {
        ...
        return redirect('admin/newsletter?type='.$com)->with('status','Gửi thư thành công');
    ...
    public function getDelete($id)
    {
        ...
        return redirect('admin/newsletter?type='.$com)->with('status','Xóa thành công');
    }
